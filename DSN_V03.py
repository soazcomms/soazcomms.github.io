...
if sensor_name == 'TESS':
    ...
    use_cols=[0,1,2,3,4]
if sensor_name == 'SQM1' or sensor_name == 'TESS1':
...
if sensor_name=="TESS":
    cols_df=['UTC','SQM','lum','chisquared','moonalt','LST']
else:
    cols_df=['UTC','SQM','lum','chisquared','moonalt','LST','Skytemp']
...
if sensor_name=="TESS":
    df.Stempc=np.around(df.Stempc,2)
#print(df.head())
#
