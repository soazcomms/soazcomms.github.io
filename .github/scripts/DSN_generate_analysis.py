...
fig_hist.write_image(f"plot1_histogram.png", width=600, height=400)
...
plt.tight_layout()
fig.savefig("plot2_heatmap.png", dpi=150)
plt.close(fig)

# HTML wrapper with larger height to avoid scrolling
with open("plot2_heatmap.html", "w") as f:
    f.write("""
<h2>4. Heatmap</h2>
   <img src="plot2_heatmap.png" width="100%" height="1000" alt="Heatmap">
    """)
#
# Chi² histogram
fig_chi2 = px.histogram(df_all, x='chisquared', nbins=100,
                         title="chisquared Histogram")
fig_chi2.write_image(f"plot4_chisq.png", width=600, height=400)
# Save interactive HTML
pio.write_html(fig_hist, file="plot1_histogram.html",
               include_plotlyjs='cdn', full_html=False)
pio.write_html(fig_jelly, file="plot3_jellyfish.html",
               include_plotlyjs='cdn', full_html=False)
pio.write_html(fig_chi2, file="plot4_chi2.html",
               include_plotlyjs='cdn', full_html=False)
