...
ytick_labels_present = [str(h % 24) for h in yticks_present]  # show 0–6 not 24–30
...
ax.set_title("Heatmap of SQM (MST 18:00–06:00, 10-min bins)", fontsize=13)
...
<img src="plot4_heatmap.png" width="100%" height="800" alt="Heatmap of SQM values">
""")
#
# Sigma histogram
