...
# influxDB options
ficha='LKXtshm7XHpORxczh-ZHJ5JViRk1XDEZuj3YF2wMLHoWV4KafApd7yO6DgUCHp07f_VaRj8pIi8LvkGJSWJNZQ=='
...
# for influxDB
    influx_file="DSNdata/NEW/DSN-"+ in_file[12:in_file.find(".")]+".csv"
    print("InfluxDB file name ",influx_file)
else:
    influx_file="DSNdata/NEW/DSN-TEMPORARY.csv"
#
##################
